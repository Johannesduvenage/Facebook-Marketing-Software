...
<style>
    ...
    select#search_page_name, input#campaign_name {
        width: 100%;
        margin-bottom: 10px;
    }
    .modal-header {
...
<section class="content user-box">  
	<div class="row" >
		<div class="col-md-12 col-sm-12 col-xs-12">
                    <h3 class = 'text-info' style="margin: 0px;"> <i class='fa fa-reply-all'></i> Auto Private Reply Report </h3>
		...
		<div id="tb" >
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<button class="btn btn-info btn-md"  onclick="doSearch(event)"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("Search");?></button>    
...
<div class="modal fade  user-box" id="view_report" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title text-center" style="margin:0px;width:100% !important;">Report of auto reply</h3>
            </div>
            <div class="modal-body modal-body1 text-center" id="view_report_modal_body">                
...
<div class="modal fade  user-box " id="edit_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog ">
        <div class="modal-content">
				...
				<div class="col-xs-12" style="margin-top: 15px;">
					...
					<div class="col-xs-12" id="edit_generic_message_div" style="display: none;">
						<div class="form-group">
							...
							<textarea class="form-control message" name="edit_generic_message" id="edit_generic_message" placeholder="Type your message here..." style="height:170px;border-bottom-right-radius: 0px;border-bottom-left-radius: 0px;padding: 10px;"></textarea>
            ...
            <div class="modal-footer text-center footer-btn">                
				<button class="btn btn-md btn-info" id="edit_save_button">Update</button>
            </div>
        </div>
    </div>
</div>
