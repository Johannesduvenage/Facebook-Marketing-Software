...
<div class=" col-md-12 col-sm-12  col-xs-12 user-box">       
    <div class="well" style="padding:0px;">
		<h3 class="text-center blue"> <i class="fa fa-facebook-official"></i> Auto Private Reply : Page List</h3>
		</div>
	</div>
</div>
<div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="row">
              ...
              <div class="text-center col-md-4 col-xs-12 left">
                  <div class="img-cont1">
                <img src="<?php echo $profile_picture;?>" alt="" class='custom-top-margin img-circle img-responsive center-block' style='padding:2px;'>
                  </div>
              	<a style="display: block; margin-top: 5px;" target="_blank" href="<?php echo base_url('facebook_ex_autoreply/auto_reply_report').'/'.$value['id']; ?>" class="btn btn-default btn-md view_repo btn-2"><i class="fa fa-binoculars"></i> View report</a>
             
              </div>
              <div class="col-md-8 col-xs-12">
                <br/>
                <div class="info-box card-default text-center" style="margin-bottom:5px;border:1px solid #ccc;border-bottom:2px solid #ccc;">
            ...
            <div class="row">             
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12"> 
              	<button class="btn btn-info btn-md get_post" table_id="<?php echo $value['id']; ?>"><i class="fa fa-spinner"></i> Get latest posts & enable auto reply</button>
              </div> 
...
<script>
	...
	$j(document).ready(function(){
		...
		$(".get_post").click(function(){
			...
			$.ajax({
			  type:'POST' ,
			  url:"<?php echo base_url();?>facebook_ex_autoreply/import_latest_post",
...
<div class="modal fade" id="post_synch_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog  modal-lg user-box" style="width:90%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title text-center" style="margin:0px;width: 100%;"><i class="fa fa-spinner"></i> Latest post for page - <span id="page_name_div"></span></h3>
            </div>
...
<div class="modal fade" id="auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog user-box">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" id='modal_close' class="close">&times;</button>
                <h3 class="modal-title text-center" style="margin:0px;">Please give the following information for post auto private reply</h3>
            </div>
            ...
            <div class="modal-footer text-center footer-btn">                
				<button class="btn btn-md btn-info" id="save_button">Save</button>
            </div>
        </div>
    </div>
</div>
