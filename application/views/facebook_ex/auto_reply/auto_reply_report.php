...
<section class="content user-box">  
	<div class="row " >
		<div class="col-md-12 col-sm-12 col-xs-12">
                    <h3 class = 'text-info' style="margin: 0px;"><?php echo $page_name." - auto private reply report";?> </h3>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title text-center" style="margin:0px;">Report of auto reply</h3>
            </div>
