...
<section class="content ">  
	<div class="row" >
		<div class="col-md-12 col-sm-12 col-xs-12 user-box">
                    <h3 class = 'text-info' style="margin:0px;"><i class="fa fa-list"></i> <?php echo $this->lang->line("Campaign Report");?></h3>
			...
			<div id="tb" style="padding:3px">
				...
				<div class="row">
					<div class="col-xs-12">
						<a style="margin-bottom: 5px;margin-left: 30px;" class="btn btn-info" href="<?php echo site_url('facebook_ex_campaign/create_multipage_campaign');?>"  title="<?php echo $this->lang->line("Create New Campaign"); ?>">
						<i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("Create New Campaign"); ?>
						</a><br/>
					</div>
				</div>

				<form class="form-inline col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;padding-left: 0px;">
                                            
					<div class="form-group form-group2 col-md-4 col-sm-6 col-xs-12 left">
						<input id="search_campaign_name" name="search_campaign_name" value="<?php echo $search_campaign_name;?>" class="form-control" placeholder="Campaign Name">
					</div>
					...
					<div class="form-group form-group2 col-md-4 col-sm-6 col-xs-12 left">
						<input id="scheduled_from" value="<?php echo $search_scheduled_from;?>" name="scheduled_from" class="form-control datepicker" placeholder="Scheduled from">
					</div>

					<div class="form-group form-group2 col-md-4 col-sm-6 col-xs-12 left">
						<input id="scheduled_to" value="<?php echo $search_scheduled_to;?>" name="scheduled_to" class="form-control  datepicker" placeholder="Scheduled to">
					</div>                    
                                    <div class="col-md-4 col-sm-6 col-xs-12 left">
					<button class='btn btn-success btn-md'  onclick="doSearch(event)"><?php echo $this->lang->line("search campaign");?></button> 				
                                    </div>
                                    </div>  
...
<div class="modal fade" id="sent_report_modal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg ">
		<div class="modal-content   ">
			<div class="modal-header col-md-12 col-sm-12 col-xs-12 user-box1" >
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="col-md-12 col-sm-12 col-xs-12 text-info" style="margin:0px;"><i class="fa fa-th-list"></i> Campaign Report</h3>
			</div>
