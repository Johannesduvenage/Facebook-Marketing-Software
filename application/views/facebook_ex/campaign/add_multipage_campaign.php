...
<div class="row padding-20">
	<div class="col-xs-12 col-md-8 padding-10">
		<div class="box box-primary">
			<div class="box-header ui-sortable-handle  text-center" style="cursor: move;margin-bottom: 0px;">
				...
				<h3 class="box-title1"><i class="fa fa-paper-plane"></i> Multi-page Campaign</h3>
				<!-- tools box -->
			...
			<div class="box-body">
				<form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
					...
					<div class="form-group form-group2  col-xs-12 col-md-12" style="padding:0px">
						...
						<textarea class="form-control" name="message" id="message" placeholder="Type your message here..." style="height:170px;border-bottom-right-radius: 0px;border-bottom-left-radius: 0px;" style="padding:0px"></textarea>
					...
					<div class="form-group form-group2 col-xs-12 col-md-12 text-center">
                                            ...
                                            <h4 style="margin:30px 0;" title="Eiher url or video will be previewed and attached at the bottom of message" class="text-center">OR</h4>
					</div>	
					...
					<div class="form-group form-group2">
						<label style="width:100%">
							Choose pages *
							 ...
							 <span class='label label-info pull-right' style="padding:7px 8px;font-size:13px;-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 5px;">Total Lead Selected : <span id="thread_count">0</span></span>
						</label>
					...
					<div class="row">
						<div class="form-group form-group2 col-xs-12 col-md-12">
							<label  class="col-md-4 col-sm-12 col-xs-12 control-label label-txt left" style="padding:0px">
								Delay time (seconds)
								 <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus" title="Delay time" data-content="Delay time is the delay between two successive message send. It is very important because without a delay time facebook may treat bulk sending as spam.  Put input integer value in seconds upto 15 secs. Keep it '0' to get random delay."><i class='fa fa-info-circle'></i> </a>
                                                    ...
                                                    <div class="col-md-8 col-sm-12 col-xs-12 right" style="padding:0px;">
					...
					<div class="form-group form-group2 schedule_block_item col-xs-12 col-md-12" style="padding:0px">
						<label  class="col-md-12 col-sm-12 col-xs-12 control-label label-txt">Schedule time  <a href="#" data-placement="top"  data-toggle="popover" data-trigger="focus" title="Schedule Time" data-content="Select date and time when you want to process this campaign."><i class='fa fa-info-circle'></i> </a></label>
					     <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input placeholder="Time"  name="schedule_time" id="schedule_time" class="form-control datepicker" type="text"/>
                                             </div>
                                        </div>

					<div class="form-group form-group2 schedule_block_item col-xs-12 col-md-6">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label label-txt">
							Time zone
	...
	<div class="col-xs-12 col-md-4 padding-10">
		<div class="box box-primary">
			<div class="box-header ui-sortable-handle  text-center" style="cursor: move;margin-bottom: 0px;">
				
				<h3 class="box-title1"><i class="fa fa-facebook-official"></i>Inbox Preview</h3>
				<!-- tools box -->
				<div class="pull-right box-tools"></div><!-- /. tools -->
			</div>
			...
			<div class="box-header ui-sortable-handle  text-center" style="cursor: move;margin-bottom: 0px;">
				...
				<h3 class="box-title1"><i class="fa fa-cogs"></i>Send Test Message</h3>
				<!-- tools box -->
				<div class="pull-right box-tools"></div><!-- /. tools -->
			</div>
			<div class="box-body" id="test_msg_box_body">
				<div class="alert" id="test_send_modal_content">
					<form id="test_message_form">
	                    ...
	                    <div class="box-footer clearfix">
						<div class="col-xs-12 footer-btn ">
							<button class="btn btn-info center-block btn-md" id="submit_test_post" name="submit_test_post" type="button"><i class="fa fa-envelope"></i> Send Test Message </button>
						</div> 
                            </div>
					</form>
				</div>
