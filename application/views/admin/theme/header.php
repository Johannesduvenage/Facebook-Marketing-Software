  ...
  <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo site_url()."facebook_ex_dashboard/index"; ?>">
                        <!-- Logo icon -->
                        <b>
                        ...
                        <span>
                         ...
                         <!-- Light Logo text -->    
                         <img src="<?php echo base_url();?>assets/admin/images/logo-lght-text.png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
