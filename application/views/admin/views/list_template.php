...
<div class="flexigrid " data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="mDiv table-heading">
		<div class="ftitle">
                    <h4 class="card-title"><?php echo $subject?></h4>
		</div>		
	</div>
	<div id='main-table-box' class="main-table-box card card-outline-info">
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
		<div class="tDiv2 col-md-5 col-sm-3">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='btn btn-warning col-md-3'>							
	...
	<div class="sDiv quickSearchBox col-lg-12 form-body" id='quickSearchBox' >
		<div class="sDiv2 row col-lg-12">
                     <div class="col-md-5 col-sm-5">
			<div class="form-group form-group3">
				<input type="text"  placeholder="<?php echo $CI->lang->line("keyword"); ?>" class="qsbsearch_fieldox search_text form-control" name="search_text" size="30" id='search_text'>
                        </div></div>
