   ...
   <section class="content col-md-8 col-sm-12 col-xs-12 form-cont">
     <div class="box box-info custom_box user-box">
       <div class="box-header">
         <h3 class="box-title"> <?php echo $this->lang->line("edit")." - ".$this->lang->line("package settings"); ?></h3>
       </div><!-- /.box-header -->
       <!-- form start -->
       <form class="form-horizontal" action="<?php echo site_url().'payment/update_package_action';?>" method="POST">
         <div class="box-body">
          ...
          <div class="form-group edit-box">
              <div class="col-sm-12">
             <label class="col-md-12 col-sm-12 control-label" for=""><?php echo $this->lang->line("modules")?> * </label>
             <div class="col-md-12 col-sm-12 table-responsive">

             <table class="table table-bordered table-condensed table-hover table-striped edit-table" style="width:100%;">
              <tr>
