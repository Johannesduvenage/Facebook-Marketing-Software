...
<section class="content">  
	<div class="row" >
		<div class="col-md-8 col-sm-12 col-xs-12 user-box">		

			
			<div class="grid_container well table-responsive" style="padding:0px;">
                            <h3  style="margin-top:0px;"> <?php echo $this->lang->line("usage log");?> : <?php echo $this->lang->line($month)."-".$cur_year ?></h3>
					   ...
					   <?php echo $validity;?> <?php echo $this->lang->line("days")?>	<br/><br/>
                                           <span style="color: #a6b7bf;"> <?php echo $this->lang->line("expired date");?> : <?php echo date("Y-m-d",strtotime($this->session->userdata("expiry_date"))); ?>	</span>		
					</div>
				</h4>	
