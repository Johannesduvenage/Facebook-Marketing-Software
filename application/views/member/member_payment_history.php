...
<!-- Main content -->
<section  style="background: rgba(0, 192, 239, 0.05) !important;padding:15px;" class="alert alert-warning col-sm-12 user-box">
  <div class="row">
...
<section class="content-header user-box" style="margin-top:30px;">
  <h3> <?php echo $this->lang->line("payment history"); ?> </h1>
...
<section class="content">  
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="grid_container" style="width:100%; height:700px;margin-top: -8px;">
            <table 
            id="tt"  
       ...
       <div id="tb" style="padding:3px">
            ...
            <form class="form-inline" style="margin-top:20px">
                ...
                <div class="form-group form-group2">
                    <input id="first_name" name="first_name" class="form-control" placeholder="<?php echo $this->lang->line("first name"); ?>">
                </div> 

                <div class="form-group form-group2">
                    <input id="last_name" name="last_name" class="form-control"  placeholder="<?php echo $this->lang->line("last name"); ?>">
                </div> 

                <div class="form-group form-group2">
                    <input id="from_date" name="from_date" class="form-control datepicker" placeholder="<?php echo $this->lang->line("from date"); ?>">
                </div>

                <div class="form-group form-group2">
                    <input id="to_date" name="to_date" class="form-control  datepicker" placeholder="<?php echo $this->lang->line("to date"); ?>">
                </div>  

                <button class='btn btn-info'  onclick="doSearch(event)" style="margin-top: -10px;padding: 9px;"><?php echo $this->lang->line("search"); ?></button>
