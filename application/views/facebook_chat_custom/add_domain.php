...
<section class="content-header col-md-8 col-sm-12 col-xs-12 user-box">
			...
			<form class="form-horizontal" action="<?php echo site_url().'fb_chat_plugin_custom/add_domain_action';?>" method="POST">
				<div class="box-body">
					...
					<div class="form-group">
                                            <div class="col-sm-12">
						<label class="col-md-3 col-sm-12 col-xs-12 control-label left label-txt" >Domain Name 
						</label>
						<div class="col-md-9 col-sm-12 col-xs-12 right">
					...
					<div class="form-group">
                                            <div class="col-sm-12">
						<label class="col-md-3 col-sm-12 col-xs-12 control-label left label-txt" >Message Header 
						</label>
						<div class="col-md-9 col-sm-12 col-xs-12 right">
					...
					<div class="form-group">
                                            <div class="col-sm-12">
						<label class="col-md-3 col-sm-12 col-xs-12 control-label left label-txt" >FB Page Url 
						</label>
						<div class="col-md-9 col-sm-12 col-xs-12 right">
				...
				<div class="box-footer">
					<div class="form-group footer-btn">
							...
							<input name="submit" id="submit" type="submit" class="btn btn-info btn-md" value="<?php echo $this->lang->line("save");?>"/>  
							<input type="button" class="btn btn-default btn-md" value="<?php echo $this->lang->line("cancel");?>" onclick='goBack("fb_chat_plugin_custom/fb_chat_domain_list")'/>  
						</div>
					</div>
				</div><!-- /.box-footer -->         
