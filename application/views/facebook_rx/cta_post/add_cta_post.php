...
<style>.xdsoft_datetimepicker{display:none;}</style>
<div class="row padding-20">
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div class="box box-primary user-box">
			<div class="box-header ui-sortable-handle" style="cursor: move;">
				
                            <h3 class="box-title" style="margin:0px;"><i class="fa fa-paper-plane "></i>CTA (Call to Action) Poster</h3>
				<!-- tools box -->
			...
			<div class="box-body box-body1">
				<form action="#" enctype="multipart/form-data" id="cta_poster_form" method="post">
					<div class="form-group form-group4">
						...
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Campaign Name</label>
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Message</label>
                                                <div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Paste link</label>
                                                <div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Preview image URL</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
                                        ...
                                        <div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left"><?php echo $this->lang->line('Upload');?></label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                    <div id="link_preview_upload">Upload</div>
                                                 </div>
                                             </div>
                                        </div>
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Title</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Description</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">CTA button type</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4 cta_value_container_div">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">CTA button action link</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group4">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Post to pages</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div id="like_comment_Share_reply_block" style="margin-top:30px !important" class="<?php echo $like_comment_Share_reply_block_class;?>">
						<div class="form-group form-group5">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto share this post</label><br/>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                        <input name="auto_share_post" value="1" id="auto_share_post_enable" type="radio"> Enable&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="auto_share_post" value="0" id="auto_share_post_disable" type="radio" checked> Disable
                                                        </div>
                                                    </div>
                                                </div>

						<div class="form-group auto_share_post_block_item form-group5">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto share to timeline</label><br/>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                        <input name="auto_share_to_profile" value="<?php echo $facebook_rx_fb_user_info_id;?>" id="auto_share_to_profile_yes"  type="radio"> Share to timeline (<?php echo $facebook_rx_fb_user_info_name;?>) &nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="form-group auto_share_post_block_item form-group5">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto share as pages</label>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
						...
						<div class="form-group form-group5">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto like this post as all other pages</label><br/>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                        <input name="auto_like_post" value="1" id="auto_like_post_enable" type="radio"> Enable&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="auto_like_post" value="0" id="auto_like_post_disable" type="radio" checked> Disable
                                                        </div>
                                                    </div>
                                                </div>
						...
						<div class="form-group form-group5">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto private reply on user comments</label><br/>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                        <input name="auto_private_reply" value="1" id="auto_private_reply_enable"  type="radio"> Enable&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="auto_private_reply" value="0" id="auto_private_reply_disable" type="radio" checked> Disable
                                                        </div>
                                                    </div>
                                                </div>

						<div class="form-group form-group5 auto_reply_block_item">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Private reply</label>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
						...
						<div class="form-group">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Auto comment</label><br/>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                        <input name="auto_comment" value="1" id="auto_comment_enable"  type="radio"> Enable&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="auto_comment" value="0" id="auto_comment_disbale" type="radio" checked> Disable
                                                        </div>
                                                     </div>
                                                </div>
						<div class="form-group form-group5 auto_comment_block_item">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
							<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Comment</label>
							<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group5">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Schedule</label><br/>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group form-group5 schedule_block_item">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Schedule time</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
					...
					<div class="form-group schedule_block_item">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
						<label class="col-md-12 col-sm-12 col-xs-12 control-label left">Time zone</label>
						<div class="col-md-12 col-sm-12 col-xs-12 right">
                                                    <?php
			 ...
			 <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="box-footer margin-footer clearfix">
                                                <div class="footer-btn">
						<button class="btn btn-md btn-info" submit_type="text_submit" id="submit_post" name="submit_post" type="button"><i class="fa fa-send"></i> Submit Post </button>
                                                </div>
                                             </div>
                                        </div>
		</div>
	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div class="box box-primary  user-box">
			<div class="box-header ui-sortable-handle" style="cursor: move;">
                            ...
                            <h3 class="box-title" style="margin:0px;"><i class="fa fa-facebook-official"></i> Preview</h3>
				<!-- tools box -->
				<div class="pull-right box-tools"></div><!-- /. tools -->
			</div>
			<div class="box-body preview">	
				...
				<div class="preview_og_info clearfix">
					...
					<div class="button_container"><a class="cta-btn btn btn-sm btn-default pull-right">Message Page</a></div>
				</div>
	...
	$j("document").ready(function(){
        ...
        $(document.body).on('keyup','#link_description',function(){  
	     ...
	     $(document.body).on('click','#submit_post',function(){ 
    		...
    		if($("#link").val()=="")
    		{
    			alert("Please paste a link to post.");
    			return;
    		}

    		if($("#cta_value").val()=="" || $("#cta_type").val()=="")
    		{
    			alert("Please select cta button type and enter cta button action link.");
    			return;
    		}
        	...
        	{
        		alert("Please select pages to publish this post.");
        		return;
        	}
        	...
        	{
        		alert("Please select timeline or page(s) for auto sharing.");
        		return;
        	}
        	...
        	{
        		alert("Please type private reply message.");
        		return;
        	}
        	...
        	{
        		alert("Please type auto comment message.");
        		return;
        	}
