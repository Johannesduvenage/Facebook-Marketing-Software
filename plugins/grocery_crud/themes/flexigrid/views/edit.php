...
<!-- Addded by Al-amin -->
<div class="flexigrid crud-form col-md-8 col-sm-12 col-xs-12 form-cont" data-unique-hash="<?php echo $unique_hash; ?>">
	<div class="mDiv">
		<div class="ftitle">
			<div class='ftitle-left center'>
...
<div id='main-table-box'>
		...
		<div class='form-div'>
			...
			$counter = 0;
				foreach($fields as $field)
				{
					...
					$counter++;
			?>
			<div class='form-group form-group2 <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
                            <div class="col-sm-12">
				<label class="col-sm-3 control-label left" for="name" id="<?php echo $field->field_name; ?>_display_as_box">				
					<?php echo $input_fields[$field->field_name]->display_as?><?php echo ($input_fields[$field->field_name]->required)? "<span class='required'>*</span> " : ""?> 
				</label>
				<div class="col-sm-9 right" id="<?php echo $field->field_name; ?>_input_box">
    ...
    <div class="pDiv" style="padding-top:20px;">
		<!-- <div class='form-button-box'>
			<input  id="form-button-save" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-large btn-info"/>
		</div> -->
		<center>
<?php 	if(!$this->unset_back_to_list) { ?>
			<input type='button' value='<?php echo $this->l('form_update_changes'); ?>' id="save-and-go-back-button" class="btn btn-md btn-info"/>
			<input type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-md btn-default" id="cancel-button" />		
<?php 	} ?>
